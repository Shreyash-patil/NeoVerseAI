...
const Testimonials = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg  transition-all duration-200 w-72 shrink-0 border-1 border-gray-800 backdrop-blur-lg">
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-gray-300">{card.handle}</span>
                </div>
            </div>
            <p className="text-sm py-4 text-gray-400">Radiant made undercutting all of our competitors an absolute
                breeze.</p>
    ...
    return (
        ...
        `}</style>
            ...
            <div className="marquee-row w-full mx-auto max-w-full overflow-hidden relative border-1 border-b-0 border-t-gray-800 pt-3.5 ">
            ...
            <div className="marquee-row w-full mx-auto max-w-full overflow-hidden relative border-1 border-t-0 border-b-gray-800  pb-8  ">
                <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none "></div>
