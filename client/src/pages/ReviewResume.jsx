  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-gray-300">
      ...
      >
        ...
        <p className="text-xs  text-gray-400 font-light mt-1 mb-5">
          Supports only pdf
        </p>
        ...
        {/* <button
          className="w-full flex justify-center items-center gap-2 relative overflow-hidden 
             ...
             active:scale-95"
        >
          <FileText className="w-5 relative z-10" />
          <span className="relative z-10">Review resume</span>
        </button> */}
        <button
          disabled={loading}
          className={`w-full flex justify-center items-center gap-2 relative overflow-hidden 
      ...
      <div className="w-full max-w-lg p-4 bg-transparent backdrop-blur-2xl rounded-lg flex flex-col border border-gray-800 min-h-96 max-h[600px] ">
        <div className="flex items-center gap-3">
          <FileText className="w-5 h-5 text-[#07e8e4]" />
