...
import { Cone, Edit, Sparkles } from "lucide-react";
      ...
      ✕
        ...
        >
          {loading ? (
            ...
            <Edit className="w-5 relative z-10" />
          )}

          <span className="relative z-10">Generate article</span>
        </button>
      </form>

      {/* Right panel */}

      <div className="w-full max-w-2xl p-4 bg-transparent backdrop-blur-2xl rounded-lg flex flex-col border border-gray-800 min-h-96 max-h-[600px]">
        <div className="flex items-center gap-3">
          <Edit className="w-5 h-5 text-[#07e8e4]" />
        ...
        {!content ? (
          ...
          <div className="mt-3 h-full overflow-y-scroll text-sm text-gray-300">
            <div className="reset-tailwind"><Markdown>
